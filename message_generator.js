const messages = {
    ...
    messageGenerator() {
        const randomPart1 = this.getRandomPart(this.theofficeQuotes1);
        const randomPart2 = this.getRandomPart(this.theofficeQuotes2);
        const randomPart3 = this.getRandomPart(this.theofficeQuotes3);
        return (randomPart1 + '\n' + randomPart2 + '\n' + randomPart3);
    }
};
